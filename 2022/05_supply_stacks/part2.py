...
class CrateStacks:
    ...
    def process(self, procedure: Procedure):
        picked_crates = self._crates[procedure.origin][-procedure.quantity:]
        self._crates[procedure.origin] = \
            self._crates[procedure.origin][:-procedure.quantity]
        self._crates[procedure.destination] += picked_crates
